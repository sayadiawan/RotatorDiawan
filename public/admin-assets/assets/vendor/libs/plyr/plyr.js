				...
				"object" == typeof navigator &&
					(e.exports = (function () {
						...
						var x = k,
							...
							F = (e) => T(e, TextTrack) || (!k(e) && A(e.kind)),
							R = (e) => {
						...
						const Re = {
							...
							createButton(e, t) {
								...
								return (
									n.toggle
										? (a.appendChild(
												Re.createIcon.call(this, n.iconPressed, {
													class: "icon--pressed",
												})
										  ),
										  a.appendChild(
												Re.createIcon.call(this, n.icon, {
													class: "icon--not-pressed",
												})
										  ),
										  a.appendChild(
												Re.createLabel.call(this, n.labelPressed, {
													class: "label--pressed",
												})
										  ),
										  a.appendChild(
												Re.createLabel.call(this, n.label, {
								...
								me.call(
									...
									(i) => {
										...
										if (!s && ["Space", "ArrowRight"].includes(i.key))
											Re.showMenuPanel.call(this, t, !0);
										else {
											let t;
											"Space" !== i.key &&
									...
									this.listeners.bind(
										...
										(t) => {
											if (!H(t) || "Space" === t.key) {
												...
												Re.showMenuPanel.call(this, "home", H(t));
											}
										},
										i,
										!1
									),
									Re.bindMenuItemShortcuts.call(this, o, i),
									t.appendChild(o);
							},
							formatTime(e = 0, t = !1) {
								return I(e) ? Fe(e, He(this.duration) > 0, t) : e;
							},
											...
											(s = this.currentTime),
												...
												(t =
													...
													Number.isNaN(n)
														...
														: ((s / n) * 100).toFixed(2)),
												"timeupdate" === e.type &&
													Re.setRange.call(this, this.elements.inputs.seek, t);
											break;
										case "playing":
										case "progress":
							...
							durationUpdate() {
								...
								!e &&
									...
									this.config.markers.enabled && Re.setMarkers.call(this),
							...
							updateSetting(e, t, i) {
								...
								).innerHTML = Re.getLabel.call(this, e, n);
							...
							setQualityMenu(e) {
								...
								if (
									(Re.toggleMenuButton.call(this, t, s),
									Z(i),
							...
							setCaptionsMenu() {
								...
								const e = "captions",
									...
									s = Boolean(i.length);
								if (
									(Re.toggleMenuButton.call(this, e, s),
									Z(t),
									Re.checkMenu.call(this),
									!s)
								)
								...
								const n = i.map((e, i) => ({
									...
									badge:
										e.language &&
										Re.createBadge.call(this, e.language.toUpperCase()),
									list: t,
									type: "language",
								}));
								n.unshift({
									...
									n.forEach(Re.createMenuItem.bind(this)),
							...
							setSpeedMenu() {
								...
								Re.toggleMenuButton.call(this, e, i),
									Z(t),
									Re.checkMenu.call(this),
									i &&
							...
							inject() {
								...
								if (
									...
									D(this.elements.controls) || Re.findElements.call(this),
						...
						const Ze = {
							...
							build() {
								...
								D(this.elements.controls) ||
									(Re.inject.call(this), this.listeners.controls()),
									...
									(this.quality = null),
									(this.speed = null),
									Re.updateVolume.call(this),
									Re.timeUpdate.call(this),
									Re.durationUpdate.call(this),
									...
									this.config.mediaMetadata && Re.setMediaMetadata.call(this);
							},
							setTitle() {
								...
								return t && this.poster
									...
									: (this.media.setAttribute("data-poster", e),
									  ...
									  ye
											...
											.catch((t) => {
												throw (
													(e === this.poster && Ze.togglePoster.call(this, !1),
													t)
												);
											})
											.then(() => {
									...
									e(this, "media", () => {
										...
										if (
											(me.call(e, e.media, "timeupdate seeking seeked", (t) =>
												Re.timeUpdate.call(e, t)
											),
											me.call(
												e,
												e.media,
												"durationchange loadeddata loadedmetadata",
												(t) => Re.durationUpdate.call(e, t)
											),
											...
											me.call(
												...
												(t) => Re.updateProgress.call(e, t)
											),
											me.call(e, e.media, "volumechange", (t) =>
												Re.updateVolume.call(e, t)
											),
											me.call(
												e,
												e.media,
									...
									e(this, "controls", () => {
													...
													["Space", "Enter"].includes(t.key) &&
														("Enter" !== t.key
															? (t.preventDefault(),
															  t.stopPropagation(),
															  Re.toggleMenu.call(e, t))
															: Re.focusFirstMenuItem.call(e, null, !0));
												},
												null,
												!1
											),
										...
										this.bind(
											...
											this.bind(
												...
												(t) => Re.updateSeekTooltip.call(e, t)
											),
											...
											W.isWebkit &&
												Array.from(le.call(e, 'input[type="range"]')).forEach(
													(t) => {
														this.bind(t, "input", (t) =>
															Re.updateRangeFill.call(e, t.target)
														);
													}
												),
										...
										if (
											...
											if ("touchmove" === e.type)
												...
												(this.seekTime =
													...
													(this.elements.thumb.time.innerText = Fe(
														this.seekTime
													));
												const a =
									  ...
									  this.destroy.call(
											...
											() => {
												...
												Object.assign(this, {
													...
													this.isHTML5 &&
														pt.insertElements.call(this, "source", t),
