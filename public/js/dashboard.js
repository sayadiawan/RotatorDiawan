(function($) {
  ...
  $(function() {
    ...
    if ($('#Altitude').length) {
      var lineChartCanvas = $("#Altitude").get(0).getContext("2d");
      var data = {
    ...
    if ($('#Temperature').length) {
      var lineChartCanvas = $("#Temperature").get(0).getContext("2d");
      var data = {
        labels: ["2013", "2014", "2014", "2015", "2016", "2017", "2018"],
        datasets: [
          {
    ...
    if ($('#Humidity').length) {
      var lineChartCanvas = $("#Humidity").get(0).getContext("2d");
      var data = {
        labels: ["2013", "2014", "2014", "2015", "2016", "2017", "2018"],
        datasets: [
          {
    ...
    if ($('#Pressure').length) {
      var lineChartCanvas = $("#Pressure").get(0).getContext("2d");
      var data = {
        labels: ["2013", "2014", "2014", "2015", "2016", "2017", "2018"],
        datasets: [
          {
