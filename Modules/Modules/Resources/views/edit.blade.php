  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Data Module</li>
      </ol>
    </nav>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('modules.update', [$data->id_module]) }}" method="POST" id="form">
              @csrf
              @method('PUT')
              ...
              <div class="mb-3">
                ...
                <select name="upid_module" id="upid_module" class="form-control select2">
                  ...
                  @foreach ($modules as $mdl)
                    <option value="{{ $mdl->id_module }}" {{ $data->upid_module == $mdl->id_module ? 'selected' : '' }}>
                      {{ $mdl->name_module }}</option>
                  @endforeach
                </select>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="code_module" name="code_module"
                  placeholder="Masukkan kode module" value="{{ $data->code_module ?? old('code_module') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_module" name="name_module"
                  placeholder="Masukkan nama module" value="{{ $data->name_module ?? old('name_module') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input type="text" class="form-control" id="link_module" name="link_module"
                    aria-describedby="basic-addon34" value="{{ $data->link_module ?? old('link_module') }}">
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="icon_module" name="icon_module"
                  placeholder="Masukkan icon module" value="{{ $data->icon_module ?? old('icon_module') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="order_module" name="order_module"
                  placeholder="Masukkan urutan module" value="{{ $data->order_module ?? old('order_module') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control smt-tags" id="action_module" name="action_module"
                  placeholder="Masukkan aksi module" value="{{ $data->action_module ?? old('action_module') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" name="description_module" id="description_module" cols="20" rows="5"
                  placeholder="Masukkan deskripsi module">{{ $data->description_module ?? old('description_module') }}</textarea>
              </div>
