...
@section('title')
    Tambah Data Site untuk Smart Home
@endsection
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tambah Data Site untuk Smart Home</li>
            </ol>
        </nav>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Tambah Data Site untuk Smart Home</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('smarthome.device.store') }}" method="POST" id="form">
                            ...
                            <input type="hidden" name="smarthomes_id" id="smarthomes_id" value="{{ $id_smarthome }}"
                                readonly>
                            ...
                            <div class="row" style="width: 100%">
                                ...
                                @if (count($data_device) > 0)
                                    ...
                                    @foreach ($data_device as $index => $item)
                                        @if (in_array($item->id_sites, $device_in_smarthome))
                                            <div class="col-lg-3 col-md-6 col-xs-12 mb-3">
                                                <div class="form-check">
                                                    <input class="form-check-input smarthome_device" type="checkbox"
                                                        value="{{ $item->id_sites }}"
                                                        id="smarthome_device_{{ $index }}"
                                                        name="smarthome_device[{{ $item->id_sites }}]"
                                                        data-name="{{ $item->name_devices }}"
