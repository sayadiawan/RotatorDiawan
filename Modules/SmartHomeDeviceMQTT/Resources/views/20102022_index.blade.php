                ...
                <div class="col-md-6 mb-3 float-end">
                  <div class="input-group input-group-merge">
                    ...
                    <input type="text" class="form-control" placeholder="Search..." aria-label="Search..."
                      aria-describedby="basic-addon-search31" name="search" id="smarthomedevice_search"
              ...
              @if (isAccess('read', $get_module, auth()->user()->roles))
                          ...
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              @if (Storage::disk('public')->exists('icon_device/' . $item->device->image_devices) &&
                                ...
                                <img src="{{ Storage::url('icon_device/' . $item->image_devices) }}" alt="img"
                                  class="rounded" />
                              @else
                            ...
                            <div class="dropdown">
                              <a class="btn p-0" href="javascript:void(0);" data-bs-toggle="offcanvas"
                                data-bs-target="#{{ $end_name_format }}" aria-controls="offcanvasScroll">
                                <i class="fas fa-cog"></i>
                              </a>

                              <div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false"
                                tabindex="-1" id="{{ $end_name_format }}"
                                aria-labelledby="{{ $end_name_format }}Label">
                                <div class="offcanvas-header">
                                  <h5 id="{{ $end_name_format }}Label" class="offcanvas-title">
                                      ...
                                      <div class="col-md">
                                        ...
                                        <div class="mt-3">
                                          <div class="input-group mb-3">
                                            ...
                                            <input type="number" id="qty_input_{{ $index }}" name="qty_input"
                                              class="form-control form-control-sm qty_input" value="1"
                                              min="1" />
                ...
                @else
                  <div class="col-md-12 text-center">
                    ...
                    @if (isAccess('create', $get_module, auth()->user()->roles))
                      <a href="{{ url('smarthome/device/create', $id_smarthome) }}" class="btn btn-primary">Tambahkan
                        Data</a>
                    @endif
                  </div>
                @endif
        ...
        if (trigger_mic_smarthome[id_devices] == 0) {
          ...
          navigator.mediaDevices.getUserMedia({
            ...
            .then(stream /*of type MediaStream*/ => {
              ...
              $("#mic_" + id_devices).find($(".fas")).toggleClass('fa-microphone').toggleClass(
                'fa-microphone-slash');
              ...
              Swal.fire({
                ...
                html: 'Mulai merekam... <b>' + Math.round(delayInMilliseconds / 1000) + '</b>',
                ...
                didOpen: () => {
                  ...
                  timerInterval = setInterval(() => {
                    b.textContent = Math.round(parseInt(Swal.getTimerLeft()) / 1000)
