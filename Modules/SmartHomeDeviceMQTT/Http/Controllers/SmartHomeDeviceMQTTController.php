...
namespace Modules\SmartHomeDeviceMQTT\Http\Controllers;
...
class SmartHomeDeviceMQTTController extends Controller
{
  ...
  public function index(Request $request, $id_smarthome)
  {
    ...
    return view('smarthomedevicemqtt::index', compact('get_module', 'id_smarthome', 'item_smarthome', 'result'));
  }
