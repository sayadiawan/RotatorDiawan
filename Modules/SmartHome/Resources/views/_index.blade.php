                ...
                <div class="col-md-6 mb-3 float-end">
                  <div class="input-group input-group-merge">
                    ...
                    <input type="text" class="form-control" placeholder="Search..." aria-label="Search..."
                      aria-describedby="basic-addon-search31" name="search" id="smarthome_search"
              ...
              @if (isAccess('read', $get_module, auth()->user()->roles))
                  ...
                  @foreach ($result as $item)
                    <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
                      <div class="card h-100 border border-primary">
                        <div class="card-header d-flex align-items-center justify-content-between pb-10">
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="orederStatistics">
                              <a class="dropdown-item" href="{{ url('smarthome/device', $item->id_smarthomes) }}">Lihat
                                Device</a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item"
                                href="{{ route('smarthome.show', $item->id_smarthomes) }}">Detail</a>
                              <a class="dropdown-item" href="{{ route('smarthome.edit', $item->id_smarthomes) }}">Edit</a>
                              <a class="dropdown-item btn-hapus text-danger" href="javascript:void(0);"
                        ...
                        @php
                          $count_smarthomedevice = \Modules\SmartHomeDevice\Entities\SmartHomeDevice::where('smarthomes_id', $item->id_smarthomes)
                ...
                @else
                  <div class="col-md-12 text-center">
                    ...
                    @if (isAccess('create', $get_module, auth()->user()->roles))
                      <a href="{{ route('smarthome.create') }}" class="btn btn-primary">Tambahkan Data</a>
                    @endif
                  </div>
                @endif
              @endif
