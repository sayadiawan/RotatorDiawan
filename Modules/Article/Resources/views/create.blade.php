        ...
        <div class="card-body">
          <div class="d-sm-flex justify-content-center justify-content-sm-between mb-3">
            <div class="text-sm-left d-block d-sm-inline-block">
              <h4 class="card-title">Tambah Data Artikel
              </h4>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="title_article" class="form-control" placeholder="Judul..">
                  </div>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="date" name="date_article" value="{{ date('Y-m-d') }}" class="form-control">
                  </div>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea name="content_article" id="content_article" class="form-control my-editor" cols="30" rows="3"></textarea>
