    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Command Site</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">List/Add Command Site</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('set_command', [$get_data->id_sites]) }}" method="POST" id="form">
                            @csrf
                            <div class="row">

                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Nama Site</label>
                                        <div class="col-sm-10">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Tipe Site</label>
                                        <div class="col-sm-10">
                                            @php
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-primary btn-simpan">Add Command <i
            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">List Command Site</h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        @foreach ($get_data->deviceCommand as $command)
                                            @if (!isset($command->command_is_ori) || $command->command_is_ori != 1)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" data-id="{{ $command->id_sites_command }}"
                                                            data-device="{{ $get_data->name_devices }}"
