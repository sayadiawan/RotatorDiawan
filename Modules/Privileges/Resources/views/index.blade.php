        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="table-responsive text-nowrap">
              <table class="table" id="table-daftar-privileges" style="width: 100%">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Group Name</th>
...
@push('after-script')
  <script>
    $(function() {
      var table = $('#table-daftar-privileges').DataTable({
        processing: true,
        serverSide: true,
        stateSave: true,
        responsive: true,
      ...
      //delete
      $('#table-daftar-privileges').on('click', '.btn-delete', function() {
