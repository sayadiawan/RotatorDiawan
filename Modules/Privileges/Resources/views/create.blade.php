  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Tambah Data Hak Akses</li>
      </ol>
    </nav>
      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Tambah Data Hak Akses</h5>
          ...
          <div class="card-body">
            <form action="{{ route('privileges.store') }}" method="POST" id="form">
              @csrf
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_usergroup" name="name_usergroup"
                  placeholder="Masukkan nama hak akses" value="{{ old('name_usergroup') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="code_usergroup" name="code_usergroup"
                  placeholder="Masukkan kode hak akes" value="{{ old('code_usergroup') }}" />
              </div>
