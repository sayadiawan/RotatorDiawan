...
class DeviceAttributeTypeMonitoring extends Model
{
  use Uuid;
  use HasFactory;
  use SoftDeletes;
  ...
  protected $table = "tb_device_attribute_type_monitoring";
  protected $primaryKey = 'id_device_attribute_type_monitoring';
