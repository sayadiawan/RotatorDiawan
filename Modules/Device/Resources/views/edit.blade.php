      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Daftar Device</h5>
          ...
          <div class="card-body">
            <form action="{{ route('device.update', $device->id_devices) }}" method="POST" id="form"
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_devices" name="name_devices"
                  placeholder="Masukkan nama device" value="{{ $device->name_devices ?? old('name_devices') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="alias_devices" name="alias_devices"
                  placeholder="Masukkan nama alias device" value="{{ $device->alias_devices ?? old('alias_devices') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <select class="form-control select2" name="type" id="type" style="width: 100%">
                  ...
                  <option value="ac" {{ IsSelected($device->type, 'ac') }}>AC (Air Conditioner)</option>
                  <option value="humidifier" {{ IsSelected($device->type, 'humidifier') }}>Humidifier</option>
                  ...
                  <option value="stopkontak" {{ IsSelected($device->type, 'stopkontak') }}>Stopkontak</option>
                </select>
              </div>
                        ...
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content" for="is_switch_device_attribute_type">
                            ...
                            <input name="is_switch_device_attribute_type" class="form-check-input float-none"
                              ...
                              id="is_switch_device_attribute_type"
              ...
              <div class="mb-5 mt-5" id="display-attribute-mode" {!! $device->deviceattributetype->is_mode_device_attribute_type == '1' ? '' : 'style="display: none;"' !!}>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 set-grid-attribute-mode mb-3">
                    ...
                    {{-- loop --}}
                    @if ($device->deviceattributetype->is_mode_device_attribute_type == '1' ||
