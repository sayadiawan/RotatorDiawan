      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Tambah Daftar Device</h5>
          ...
          <div class="card-body">
            <form action="{{ route('device.store') }}" method="POST" id="form" enctype="multipart/form-data">
              @csrf

              <div class="mb-3">
                <label class="form-label" for="name">Nama Device</label>

                <input type="text" class="form-control" id="name_devices" name="name_devices"
                  placeholder="Masukkan nama device" value="{{ old('name_devices') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="alias_devices" name="alias_devices"
                  placeholder="Masukkan nama alias device" value="{{ old('alias_devices') }}" />
              </div>

              <div class="mb-3">
                <label class="form-label" for="type">Pilih Tipe Device</label>
                          ...
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customRadioSvg1">
                              <span class="custom-option-body">
                                <img src="{{ Storage::url($item->file_icons) }}" class="w-px-40 mb-2" alt="paypal">
                              </span>
                              <input name="icons" class="form-check-input" type="radio" value="{{ $item->id_icons }}"
                                id="icons{{ $index }}">
                            </label>
                          </div>
                        </div>
              ...
              <div class="mb-5 mt-5">
                ...
                <div class="row">
                  ...
                  {{-- tampilan attribute switch --}}
                  <div class="col-md-4 mb-md-10 mb-5">
                    <div class="card device-attribute">
                      <div class="card-body">
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content" for="is_switch_device_attribute_type">
                            <img src="{{ asset('admin-assets/assets/img/icons/unicons/turn-on.png') }}" width="50"
                              style="margin-bottom: 5px">

                            <h5 class="card-title">Attribute Switch</h5>
                            <p class="card-text">Berisikan controlling seperti tombol on dan off.
                            </p>

                            <input name="is_switch_device_attribute_type" class="form-check-input float-none"
                              style="margin-left: 0em !important" type="checkbox" value="1"
                              id="is_switch_device_attribute_type" checked="">
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  {{-- tmapilan attibute range --}}
                  <div class="col-md-4 mb-md-10 mb-5">
                    <div class="card device-attribute">
                      <div class="card-body">
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content" for="is_range_device_attribute_type">
                            <img src="{{ asset('admin-assets/assets/img/icons/unicons/slider.png') }}" width="50"
                              style="margin-bottom: 5px">

                            <h5 class="card-title">Attribute Range</h5>
                            <p class="card-text">Berisikan controlling seperti slider dengan memiliki nilai minimal dan
                              maksimal.
                            </p>

                            <input name="is_range_device_attribute_type" class="form-check-input float-none"
                              style="margin-left: 0em !important" type="checkbox" value="1"
                              id="is_range_device_attribute_type">
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-4 mb-md-10 mb-5">
                    <div class="card device-attribute">
                      <div class="card-body">
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content" for="is_color_device_attribute_type">
                            ...
                            <input name="is_color_device_attribute_type" class="form-check-input float-none"
                              style="margin-left: 0em !important" type="checkbox" value="1"
                              id="is_color_device_attribute_type">
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-4 mb-md-10 mb-5">
                    <div class="card device-attribute">
                      <div class="card-body">
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content" for="is_mode_device_attribute_type">
                            <img src="{{ asset('admin-assets/assets/img/icons/unicons/mode.png') }}" width="50"
                              style="margin-bottom: 5px">
                            ...
                            <input name="is_mode_device_attribute_type" class="form-check-input float-none"
                              style="margin-left: 0em !important" type="checkbox" value="is_mode_device_attribute_type"
                              id="is_mode_device_attribute_type">
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-4 mb-md-10 mb-5">
                    <div class="card device-attribute">
                      <div class="card-body">
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content" for="is_motion_device_attribute_type">
                            <img src="{{ asset('admin-assets/assets/img/icons/unicons/motion-sensor.png') }}"
                              width="50" style="margin-bottom: 5px">

                            <h5 class="card-title">Attribute Gerak</h5>
                            <p class="card-text">Berisikan controlling seperti menggerakkan object.
                            </p>

                            <input name="is_motion_device_attribute_type" class="form-check-input float-none"
                              style="margin-left: 0em !important" type="checkbox"
                              value="is_motion_device_attribute_type" id="is_motion_device_attribute_type">
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-4 mb-md-10 mb-5">
                    <div class="card device-attribute">
                      <div class="card-body">
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content" for="is_lock_device_attribute_type">
                            <img src="{{ asset('admin-assets/assets/img/icons/unicons/unlock.png') }}" width="50"
                              style="margin-bottom: 5px">

                            <h5 class="card-title">Attribute Kunci</h5>
                            <p class="card-text">Berisikan controlling seperti lock atau unlock object.
                            </p>

                            <input name="is_lock_device_attribute_type" class="form-check-input float-none"
                              style="margin-left: 0em !important" type="checkbox" value="is_lock_device_attribute_type"
                      ...
                      <div class="card-body">
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content"
                            ...
                            <h5 class="card-title">Attribute Monitoring</h5>
                            <p class="card-text">Berisikan controlling untuk melihat object dengan kamera.
                            </p>

                            <input name="is_monitoring_device_attribute_type" class="form-check-input float-none"
                              style="margin-left: 0em !important" type="checkbox"
                              value="is_monitoring_device_attribute_type" id="is_monitoring_device_attribute_type">
                          </label>
                        </div>
                      </div>
                    </div>
              ...
              <div class="mb-5 mt-5" id="display-attribute-switch">
                <div class="col-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label class="form-label" for="label_switch_device_attribute_type">Nama atau Label Tombol
                      Switch</label>

                    <input type="text" class="form-control" id="label_switch_device_attribute_type"
                      name="label_switch_device_attribute_type" placeholder="Nama label switch"
                      value="{{ old('label_switch_device_attribute_type') }}" />
                  </div>

                  <div class="col-md-6">
                    <label class="form-label" for="name">Kondisi text on</label>

                    <input type="text" class="form-control" id="on_txt_device_attribute_type_switch"
                      name="on_txt_device_attribute_type_switch" placeholder="Menyala/Hidup/On"
                      value="{{ old('on_txt_device_attribute_type_switch') }}" />
                  </div>

                  <div class="col-md-6">
                    <label class="form-label" for="name">Kondisi text off</label>

                    <input type="text" class="form-control" id="off_txt_device_attribute_type_switch"
                      name="off_txt_device_attribute_type_switch" placeholder="Mati/Off"
                      value="{{ old('off_txt_device_attribute_type_switch') }}" />
                  </div>
                </div>
                {{-- / show inputan detail dari attribute switch --}}
              </div>
              ...
              <div class="mb-5 mt-5" id="display-attribute-range" style="display: none">
                <div class="col-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label class="form-label" for="label_range_device_attribute_type">Nama atau Label Range</label>
                    ...
                    <input type="text" class="form-control" id="label_range_device_attribute_type"
                      ...
                      value="{{ old('label_range_device_attribute_type') }}" />
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="min_device_attribute_type_range"
                      ...
                      value="{{ old('min_device_attribute_type_range') }}" />
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="max_device_attribute_type_range"
                      ...
                      value="{{ old('max_device_attribute_type_range') }}" />
                  </div>
                </div>
                {{-- / show inputan detail dari attribute range --}}
              </div>
              ...
              <div class="mb-5 mt-5" id="display-attribute-color" style="display: none">
                <div class="col-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label class="form-label" for="label_color_device_attribute_type">Nama atau Label Color</label>
                    ...
                    <input type="text" class="form-control" id="label_color_device_attribute_type"
                      ...
                      value="{{ old('label_color_device_attribute_type') }}" />
                  </div>
                </div>
                {{-- / show inputan detail dari attribute color --}}
              </div>
              ...
              <div class="mb-5 mt-5" id="display-attribute-mode" style="display: none">
                <div class="col-12">
                ...
                <div class="row">
                  <div class="col-md-12 mb-3">
                    <label class="form-label" for="label_mode_device_attribute_type">Nama atau Label Mode</label>
                    ...
                    <input type="text" class="form-control" id="label_mode_device_attribute_type"
                      ...
                      value="{{ old('label_mode_device_attribute_type') }}" />
                  </div>
                  ...
                  <div class="col-md-12 text-center mb-3">
                    <button type="button" class="btn btn-success btn-sm btn-add-attribute-mode" data-param="0">Tambah
                      Mode</button>
                  </div>
                </div>
                {{-- / show inputan detail dari attribute mode --}}
              ...
              <div class="mb-5 mt-5" id="display-attribute-motion" style="display: none">
                <div class="col-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label class="form-label" for="label_motion_device_attribute_type">Nama atau Label Motion</label>

                    <input type="text" class="form-control" id="label_motion_device_attribute_type"
                      name="label_motion_device_attribute_type" placeholder="Nama label motion"
                      value="{{ old('label_motion_device_attribute_type') }}" />
                  </div>
                </div>
                {{-- / show inputan detail dari attribute motion --}}
              </div>
              ...
              <div class="mb-5 mt-5" id="display-attribute-lock" style="display: none">
                <div class="col-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label class="form-label" for="label_lock_device_attribute_type">Nama atau Label Lock</label>
                    ...
                    <input type="text" class="form-control" id="label_lock_device_attribute_type"
                      ...
                      value="{{ old('label_lock_device_attribute_type') }}" />
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="on_txt_device_attribute_type_lock"
                      ...
                      value="{{ old('on_txt_device_attribute_type_lock') }}" />
                  </div>

                  <div class="col-md-6">
                    <label class="form-label" for="name">Kondisi lock</label>

                    <input type="text" class="form-control" id="off_txt_device_attribute_type_lock"
                      name="off_txt_device_attribute_type_lock" placeholder="Menutup/Off/0"
                      value="{{ old('off_txt_device_attribute_type_lock') }}" />
                  </div>
                </div>
                {{-- / show inputan detail dari attribute lock --}}
              </div>
              ...
              <div class="mb-5 mt-5" id="display-attribute-monitoring" style="display: none">
                <div class="col-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label class="form-label" for="label_monitoring_device_attribute_type">Nama atau Label
                      Monitoring</label>

                    <input type="text" class="form-control" id="label_monitoring_device_attribute_type"
                      name="label_monitoring_device_attribute_type" placeholder="Nama label monitoring"
                      value="{{ old('label_monitoring_device_attribute_type') }}" />
                  </div>
                </div>
                {{-- / show inputan detail dari attribute monitoring --}}
              </div>
