...
@push('after-style')
    ...
    <script src="{{ asset('admin-assets/js/firebase-js/firebase/config-premium.js') }}"></script>


    {{-- <script src="{{ asset('admin-assets/js/firebase-js/firebase/config.js') }}"></script> --}}
    {{-- <script src="{{ asset('admin-assets/js/firebase-js/firebase/config-stater-premium.js') }}"></script> --}}

    {{-- <script src="{{ asset('assets/admin/js/firebase-js/firebase/config-stater.js')}}"></script>
<script src="{{ asset('assets/admin/js/firebase-js/firebase/config-premium.js')}}"></script> --}}
    ...
    <script>
        ...
        const database_premium = getDatabase(app);
    </script> --}}
@endpush
