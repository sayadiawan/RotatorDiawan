  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Data Room</li>
      </ol>
    </nav>
      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Data Room</h5>
          ...
          <div class="card-body">
            <form action="{{ route('room.update', $data->id_rooms) }}" method="POST" id="form">
              @csrf
              @method('PUT')
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_rooms" name="name_rooms"
                  placeholder="Masukkan nama hak akses" value="{{ $data->name_rooms ?? old('name_rooms') }}" />
              </div>

              <div class="mb-3">
                <label class="form-label" for="code_rooms">Kode Room</label>
                <input type="text" class="form-control" id="code_rooms" name="code_rooms"
                  placeholder="Masukkan kode hak akes" value="{{ $data->code_rooms ?? old('code_rooms') }}" />
              </div>
