...
>
  <head>
    ...
    <title>Diawan | Login</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('admin-assets/assets/img/icons/diawan_logo_small.png') }}" />
              ...
              <div class="app-brand justify-content-center">
                <a href="{{ route('login') }}" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="{{ asset('admin-assets/assets/img/icons/diawan_logo.png') }}" style="width: 180px; height: 70px" alt="" />
                  </span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Diawan! 👋</h4>
              <p class="mb-4">Please sign-in to your account and start the our IoT Experience</p>

              <form id="form-login" class="mb-3" action="{{ route('login') }}" method="POST">
                @csrf
